...
class App_EPorra(QApplication):
    ...
    def editar_apuesta(self, id_apust, valor):
        """
        Esta función edita la información de una apuesta
        """
        self.logica.editar_apuesta(self.carrera_actual, id_apust, valor)
        nombre_carrera = self.logica.dar_carrera(self.carrera_actual)['Nombre']
        self.vista_lista_apuestas.mostrar_apuestas(nombre_carrera, self.logica.dar_apuestas_carrera(self.carrera_actual))

    def eliminar_apuesta(self, id_apust):
        """
        Esta función elimina una apuesta
        """
        self.logica.eliminar_apuesta(self.carrera_actual, id_apust)
        nombre_carrera = self.logica.dar_carrera(self.carrera_actual)['Nombre']
        self.vista_lista_apuestas.mostrar_apuestas(nombre_carrera, self.logica.dar_apuestas_carrera(self.carrera_actual))
