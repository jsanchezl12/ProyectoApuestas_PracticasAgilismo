...
class Dialogo_crear_apuesta(QDialog):
    ...
    def __init__(self, apostadores, competidores, apuesta=None):
        ...
        if apuesta != None:
            ...
            # nom_apost = self.getNombreApostador(apuesta["Apostador"])
            # indice_apostador = self.combobox_apostadores.findText(nom_apost)
    ...
    # def getNombreApostador(self, id_apostador):
    #     """
    #     Esta función permite obtener el nombre de un apostador
    #     """
    #     return self.interfaz.dar_nom_apost(id_apostador)
